...
public class DevelopersTableMsSql : IMsSqlEnforcedEntity
{
    private const string TableName = "Developers";

    public IEnumerable<ISqlDatabaseScript> GetDbScripts() => typeof(DevelopersTableMsSql).GetDbScriptsFromClass();
